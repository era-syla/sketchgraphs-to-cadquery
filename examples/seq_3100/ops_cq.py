...
edges = []
direct_wires = []
edges.append(cq.Edge.makeLine(V(-0.12699999999999997, 0.142875), V(0.127, 0.142875)))
edges.append(cq.Edge.makeLine(V(-0.127, -0.142875), V(0.12699999999999997, -0.142875)))
edges.append(cq.Edge.makeLine(V(-0.14604999999999999, 0.123825), V(-0.14605000000000004, -0.123825)))
edges.append(cq.Edge.makeLine(V(0.14605000000000004, 0.123825), V(0.14604999999999999, -0.123825)))
edges.append(cq.Edge.makeCircle(0.019050000000000001, V(-0.12699999999999997, 0.123825), cq.Vector(0,0,1), 90, 180))
edges.append(cq.Edge.makeCircle(0.019050000000000001, V(0.12700000000000003, 0.123825), cq.Vector(0,0,1), 0, 90))
edges.append(cq.Edge.makeCircle(0.019050000000000001, V(0.12699999999999997, -0.123825), cq.Vector(0,0,1), -90, 0))
edges.append(cq.Edge.makeCircle(0.019050000000000001, V(-0.12700000000000003, -0.123825), cq.Vector(0,0,1), -180, -90))
direct_wires.append(cq.Wire.makeCircle(0.011112500000000001, V(0, 0), cq.Vector(0,0,1)))
# ---------- END PRIMITIVES ----------
