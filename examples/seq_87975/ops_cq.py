...
edges = []
direct_wires = []
edges.append(cq.Edge.makeCircle(0.35722814149164406, V(0.25562814149164409, -0.28736819587421303), cq.Vector(0,0,1), -180, -102.583768986))
edges.append(cq.Edge.makeCircle(0.83570318546936151, V(0.93730318546936153, -0.28736819587421314), cq.Vector(0,0,1), -180, -155.342694335))
edges.append(cq.Edge.makeCircle(0.30480000000000002, V(0, 0), cq.Vector(0,0,1), -109.471220634, -70.5287793655))
# ---------- END PRIMITIVES ----------
