...
edges = []
direct_wires = []
edges.append(cq.Edge.makeCircle(0.0090000000000000011, V(-8.5963735186871748e-20, 0.010999999999999999), cq.Vector(0,0,1), 1.40334185971e-14, -180))
direct_wires.append(cq.Wire.makeCircle(0.0052500000000000003, V(-8.5963735186871748e-20, 0.010999999999999999), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeCircle(0.0090000000000000011, V(2.6082592229373055e-18, -0.010999999999999999), cq.Vector(0,0,1), -180, 2.20871852879e-14))
direct_wires.append(cq.Wire.makeCircle(0.0052500000000000003, V(2.6082592229373055e-18, -0.010999999999999999), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeLine(V(-0.0090000000000000011, 0.010999999999999999), V(-0.0089999999999999959, -0.011000000000000001)))
edges.append(cq.Edge.makeLine(V(0.0090000000000000011, 0.010999999999999999), V(0.0090000000000000045, -0.010999999999999996)))
# ---------- END PRIMITIVES ----------
