...
edges = []
direct_wires = []
direct_wires.append(cq.Wire.makeCircle(0.038100000000000002, V(0, 0), cq.Vector(0,0,1)))
direct_wires.append(cq.Wire.makeCircle(0.038100000000000002, V(0.96520000000000006, 0.1981200000000001), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeCircle(0.063500000000000001, V(0, 0), cq.Vector(0,0,1), 101.599595221, -90))
edges.append(cq.Edge.makeLine(V(0, -0.063500000000000001), V(0.96520000000000006, -0.063500000000000001)))
edges.append(cq.Edge.makeCircle(0.063500000000000001, V(0.96520000000000006, 6.9388939039072284e-18), cq.Vector(0,0,1), -90, 0))
edges.append(cq.Edge.makeLine(V(1.0287000000000002, 0), V(1.0287000000000002, 0.1981200000000001)))
edges.append(cq.Edge.makeCircle(0.063500000000000001, V(0.96520000000000006, 0.1981200000000001), cq.Vector(0,0,1), 0, 101.599595221))
edges.append(cq.Edge.makeLine(V(0.95243199145479362, 0.26032311855357049), V(-0.012768008545206655, 0.062203118553570372)))
# ---------- END PRIMITIVES ----------
