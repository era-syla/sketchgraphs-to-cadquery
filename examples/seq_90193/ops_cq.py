...
edges = []
direct_wires = []
edges.append(cq.Edge.makeLine(V(-0.092449841540230351, 0.051037185675024278), V(0.08755015845976967, 0.051037185675024334)))
edges.append(cq.Edge.makeLine(V(0.087550158459769656, 0.05103718567502432), V(0.087550158459769656, -0.0039628143249756734)))
edges.append(cq.Edge.makeLine(V(0.08755015845976967, -0.0039628143249756725), V(0.071550158459769642, -0.0039628143249756725)))
edges.append(cq.Edge.makeLine(V(0.071550158459769628, -0.003962814324975663), V(0.071550158459769628, 0.022037185675024315)))
edges.append(cq.Edge.makeLine(V(0.053550158459769619, 0.022037185675024315), V(0.053550158459769619, -0.003962814324975682)))
edges.append(cq.Edge.makeLine(V(0.053550158459769653, -0.0039628143249756725), V(-0.058449841540230481, -0.0039628143249756725)))
edges.append(cq.Edge.makeLine(V(-0.058449841540230349, -0.0039628143249756838), V(-0.058449841540230349, 0.022037185675024322)))
edges.append(cq.Edge.makeLine(V(-0.076449841540230351, 0.022037185675024312), V(-0.076449841540230351, -0.0039628143249756734)))
edges.append(cq.Edge.makeLine(V(-0.076449841540230323, -0.0039628143249756725), V(-0.092449841540230351, -0.0039628143249756725)))
edges.append(cq.Edge.makeLine(V(-0.092449841540230338, -0.0039628143249756734), V(-0.092449841540230338, 0.05103718567502432)))
edges.append(cq.Edge.makeCircle(0.0089999999999999455, V(-0.067449841540230412, 0.022037185675024315), cq.Vector(0,0,1), 3.33471016571e-14, -180))
edges.append(cq.Edge.makeCircle(0.0089999999999999455, V(0.062550158459769578, 0.022037185675024318), cq.Vector(0,0,1), 3.33471016571e-14, -180))
# ---------- END PRIMITIVES ----------
