...
edges = []
direct_wires = []
edges.append(cq.Edge.makeLine(V(0, 0), V(0.025000000000000008, 0)))
edges.append(cq.Edge.makeLine(V(-6.9388939039072284e-18, 0.025000000000000001), V(0.00050000000000000044, 0.025000000000000001)))
edges.append(cq.Edge.makeLine(V(0, 0), V(0, 0.025000000000000001)))
edges.append(cq.Edge.makeLine(V(0.025000000000000001, 0), V(0.025000000000000001, 0.00050000000000000738)))
edges.append(cq.Edge.makeLine(V(0.0039999999999999992, 0.021500000000000002), V(0.004000000000000001, 0.0075000000000000015)))
edges.append(cq.Edge.makeLine(V(0.0075000000000000015, 0.004000000000000001), V(0.021500000000000002, 0.0040000000000000044)))
edges.append(cq.Edge.makeCircle(0.0035000000000000001, V(0.00049999999999999697, 0.021500000000000002), cq.Vector(0,0,1), 0, 90))
edges.append(cq.Edge.makeCircle(0.0034999999999999996, V(0.0074999999999999997, 0.0075000000000000015), cq.Vector(0,0,1), -180, -90))
edges.append(cq.Edge.makeCircle(0.0034999999999999996, V(0.021500000000000002, 0.0005000000000000037), cq.Vector(0,0,1), 6.03453455188e-14, 90))
# ---------- END PRIMITIVES ----------
