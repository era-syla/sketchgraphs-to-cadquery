...
edges = []
direct_wires = []
edges.append(cq.Edge.makeCircle(0.22542499999999999, V(0, 0), cq.Vector(0,0,1), 59.9067738216, 66.7735487327))
edges.append(cq.Edge.makeCircle(0.088900000000000007, V(-6.9210913853812703e-18, -0.095249999999999987), cq.Vector(0,0,1), -180, 1.78883840352e-14))
edges.append(cq.Edge.makeLine(V(-0.088900000000000007, -0.095249999999999974), V(-0.088900000000000007, 0.20715506420312296)))
edges.append(cq.Edge.makeLine(V(0.088899999999999965, 0.20715506420312296), V(0.088900000000000007, -0.095249999999999974)))
edges.append(cq.Edge.makeCircle(0.11303000000000006, V(-6.9219532449621424e-18, -0.095249999999999987), cq.Vector(0,0,1), 180, 0))
edges.append(cq.Edge.makeLine(V(0.11303000000000007, -0.095249999999999987), V(0.11303000000000007, 0.19504012337208976)))
edges.append(cq.Edge.makeLine(V(-0.11303000000000009, 0.19504012337208973), V(-0.11303000000000006, -0.095249999999999974)))
edges.append(cq.Edge.makeCircle(0.22542499999999999, V(0, 0), cq.Vector(0,0,1), 113.226451267, 120.093226178))
# ---------- END PRIMITIVES ----------
