...
edges = []
direct_wires = []
direct_wires.append(cq.Wire.makeCircle(0.00075000000000000002, V(0.0074829640798270702, 0.0045621031895279884), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeLine(V(0.0071475244333361922, 0.0044429848942845454), V(0.0074184037263179533, 0.0049121615924472848)))
edges.append(cq.Edge.makeLine(V(0.0075475244333361958, 0.0049121615924472839), V(0.0078184037263179518, 0.0044429848942845393)))
edges.append(cq.Edge.makeLine(V(0.0077538433728088297, 0.0043311630818521343), V(0.0072120847868453125, 0.0043311630818521395)))
edges.append(cq.Edge.makeCircle(7.4547874954936102e-05, V(0.0074829640798270746, 0.0048748876549698159), cq.Vector(0,0,1), 30, 150))
edges.append(cq.Edge.makeCircle(7.4547874954936522e-05, V(0.0072120847868453125, 0.0044057109568070765), cq.Vector(0,0,1), 150, -90))
edges.append(cq.Edge.makeCircle(7.4547874954936956e-05, V(0.0077538433728088305, 0.0044057109568070713), cq.Vector(0,0,1), -90, 30))
# ---------- END PRIMITIVES ----------
