...
edges = []
direct_wires = []
direct_wires.append(cq.Wire.makeCircle(0.0080000000000000002, V(0, 0), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeCircle(0.016, V(0, 0), cq.Vector(0,0,1), 1.40334185971e-14, -180))
edges.append(cq.Edge.makeLine(V(-0.015999999999999993, -0.065000000000000002), V(0.016000000000000004, -0.065000000000000002)))
edges.append(cq.Edge.makeLine(V(-0.016, 0), V(-0.015999999999999997, -0.065000000000000002)))
edges.append(cq.Edge.makeLine(V(0.016, 0), V(0.016000000000000004, -0.065000000000000002)))
# ---------- END PRIMITIVES ----------
