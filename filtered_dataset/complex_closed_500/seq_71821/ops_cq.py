...
edges = []
direct_wires = []
direct_wires.append(cq.Wire.makeCircle(0.0014999999999999998, V(-0.10200000000000001, 0.041000000000000002), cq.Vector(0,0,1)))
direct_wires.append(cq.Wire.makeCircle(0.0040000000000000036, V(-0.092000000000000012, 0.041000000000000002), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeCircle(0.0060000000000000001, V(-0.092000000000000012, 0.041000000000000002), cq.Vector(0,0,1), -138.189685104, 138.189685104))
edges.append(cq.Edge.makeCircle(0.0040000000000000001, V(-0.10200000000000001, 0.041000000000000002), cq.Vector(0,0,1), 78.4630409672, -78.4630409672))
edges.append(cq.Edge.makeLine(V(-0.10200000000000001, 0.044999999999999998), V(-0.096472135954999594, 0.044999999999999998)))
edges.append(cq.Edge.makeLine(V(-0.10200000000000001, 0.037000000000000005), V(-0.096472135954999594, 0.037000000000000005)))
# ---------- END PRIMITIVES ----------
