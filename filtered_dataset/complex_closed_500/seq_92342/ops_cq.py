...
edges = []
direct_wires = []
edges.append(cq.Edge.makeCircle(0.022000000000000002, V(-0.018000000000000002, -8.2114824879746335e-19), cq.Vector(0,0,1), -90, -55.7711336722))
edges.append(cq.Edge.makeCircle(0.022000000000000002, V(-0.018000000000000002, -8.2114824879746335e-19), cq.Vector(0,0,1), -90, -55.7711336722))
edges.append(cq.Edge.makeCircle(0.022000000000000002, V(0.018000000000000002, 4.2862637970157354e-19), cq.Vector(0,0,1), -124.228866328, -90))
edges.append(cq.Edge.makeCircle(0.022000000000000002, V(0.018000000000000002, 4.2862637970157354e-19), cq.Vector(0,0,1), 90, 124.228866328))
edges.append(cq.Edge.makeCircle(0.010000000000000009, V(4.3368086899420177e-19, 0.026457513110645918), cq.Vector(0,0,1), -124.228866328, -55.7711336722))
edges.append(cq.Edge.makeCircle(0.010000000000000009, V(2.1684043449710089e-18, -0.026457513110645918), cq.Vector(0,0,1), 55.7711336722, 124.228866328))
edges.append(cq.Edge.makeLine(V(-0.018000000000000006, 0.022000000000000006), V(-5.2041704279304213e-18, 0.033400058746337891)))
edges.append(cq.Edge.makeLine(V(-3.4694469519536142e-18, 0.033400058746337891), V(0.017999999999999999, 0.022000000000000006)))
edges.append(cq.Edge.makeLine(V(-0.018000000000000006, -0.022000000000000006), V(-1.7347234759768071e-18, -0.032036788761615753)))
edges.append(cq.Edge.makeLine(V(-1.7347234759768071e-18, -0.032036788761615753), V(0.018000000000000002, -0.022000000000000002)))
# ---------- END PRIMITIVES ----------
