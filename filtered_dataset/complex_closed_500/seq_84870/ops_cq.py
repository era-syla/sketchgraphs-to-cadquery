...
edges = []
direct_wires = []
edges.append(cq.Edge.makeLine(V(0.00035069746081716721, 0.039729408027813037), V(0.00035069746081716759, 0.03673917650583601)))
edges.append(cq.Edge.makeLine(V(0.0016260207876751661, 0.036289408086407945), V(0.0078370993868175504, 0.04334463972758449)))
edges.append(cq.Edge.makeLine(V(0.00061636652465227966, 0.040171096846276996), V(0.0074713259461027526, 0.043807885896511606)))
edges.append(cq.Edge.makeCircle(0.00050000000000000001, V(0.0008506974608171675, 0.039729408027813037), cq.Vector(0,0,1), 117.947470781, 180))
edges.append(cq.Edge.makeCircle(0.00029999999999999997, V(0.0076119245078016869, 0.043542872605433228), cq.Vector(0,0,1), -41.3591016528, 117.947470781))
edges.append(cq.Edge.makeCircle(0.0007289119331448221, V(0.0010789119331448224, 0.036771055787093228), cq.Vector(0,0,1), 177.493344547, -41.3591016528))
# ---------- END PRIMITIVES ----------
