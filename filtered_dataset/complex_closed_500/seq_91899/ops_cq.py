...
edges = []
direct_wires = []
edges.append(cq.Edge.makeLine(V(-1.7347234759768071e-18, 0), V(-0.0059999999999999975, 0)))
edges.append(cq.Edge.makeLine(V(-0.0059999999999999984, 0), V(-0.0059999999999999984, 0.028000000000000001)))
edges.append(cq.Edge.makeLine(V(-0.0029999999999999983, 0.031), V(-0.0030000000000000001, 0.031)))
edges.append(cq.Edge.makeLine(V(0, 0.028000000000000001), V(0, 0.012000000000000007)))
edges.append(cq.Edge.makeLine(V(0.0080000000000000054, 0.0039999999999999975), V(0.024, 0.0040000000000000027)))
edges.append(cq.Edge.makeLine(V(0.024, 0.0040000000000000027), V(0.024, 0)))
edges.append(cq.Edge.makeLine(V(0.023999999999999997, 0), V(6.9388939039072284e-18, 0)))
direct_wires.append(cq.Wire.makeCircle(0.001, V(-0.0029999999999999983, 0.028000000000000001), cq.Vector(0,0,1)))
edges.append(cq.Edge.makeCircle(0.0030000000000000001, V(-0.0029999999999999983, 0.028000000000000001), cq.Vector(0,0,1), 90, 180))
edges.append(cq.Edge.makeCircle(0.0030000000000000001, V(-0.0029999999999999996, 0.028000000000000001), cq.Vector(0,0,1), 1.41245001538e-30, 90))
edges.append(cq.Edge.makeCircle(0.0080000000000000002, V(0.0080000000000000036, 0.011999999999999999), cq.Vector(0,0,1), -180, -90))
# ---------- END PRIMITIVES ----------
